...
- Verification after fixes: `bash scripts/run_tests.sh` passed with environment verification, ruff, and 211 pytest tests. The only warnings were the known upstream TVM/TileLang duplicate-field warnings during Mamba import.
