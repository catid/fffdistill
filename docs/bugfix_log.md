...
- T14 remains blocked rather than closed. No fake Mamba, alternate architecture, CPU path, smaller model, or optimizer fallback was used to claim success. See `docs/t14_finetune_summary.md` for exact smoke artifact paths and limitation text.
