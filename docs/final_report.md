...
`docs/loss_curves/manifest.csv` records 75 compared rows and 75 available epoch
curves across Stage H, T15 baselines, optimizer/WSD, bank-Muon, and related
validation suites. No synthetic curve data is used.
